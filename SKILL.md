...
Extracted from the `Bound by Ash and Thorn` project pipeline after successful publication of a 27-chapter, 99,772-word romantasy novel (eval score 9.626/10, 307-page PDF, clean TOC). Refactored for general use; named `autonovel-pipeline` to supersede `romantasy-autonovel` (which remains as the generator scaffold only).
